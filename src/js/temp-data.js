const data = {
  groups: [
    {id: 1, title: 'group 1', order: 1},
    {id: 2, title: 'group 2', order: 3},
    {id: 3, title: 'group 3', order: 4},
    {id: 4, title: 'group 4', order: 2},
  ],
  habits: [
    {id: 1, title: 'habit 1', groupId: null, order: 1},
    {id: 2, title: 'habit 2', groupId: 1, order: 2},
    {id: 3, title: 'habit 3', groupId: 1, order: 1},
    {id: 4, title: 'habit 4', groupId: 2, order: 2},
    {id: 5, title: 'habit 5', groupId: 3, order: 1},
    {id: 6, title: 'habit 6', groupId: 2, order: 1},
    {id: 7, title: 'habit 7', groupId: null, order: 2},
    {id: 8, title: 'habit 8', groupId: 4, order: 1},
    {id: 9, title: 'habit 9', groupId: null, order: 3},
  ],
  entries: [
